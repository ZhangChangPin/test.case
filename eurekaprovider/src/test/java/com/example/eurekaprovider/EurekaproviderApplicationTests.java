...
class EurekaproviderApplicationTests {
    ...
    public void testCreateIndex() throws IOException {
        ...
        //指定映射
        createIndexRequest.mapping("_doc","{\"properties\":{\"studymodel\":{\"type\":\"keyword\"},\"name\":{\"type\":\"keyword\"},\"description\": {\"type\":\"text\"},\"pic\":{\"type\":\"text\",\"index\":\"false\"}}}", XContentType.JSON);
        //操作索引的客户端
    ...
    public void testAddDoc() throws IOException {
        ...
        //创建索引创建对象
        IndexRequest indexRequest = new IndexRequest("elasticsearch_test","_doc");
        //文档内容
